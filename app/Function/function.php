...
function printPrice($unitPrice, $promotionPrice) {
	if ($promotionPrice == 0) {
		echo '<h4 class="product-price">'.formatPrice($unitPrice).'</h4>';
	}
	else {
		echo '<h4 class="product-price">'.formatPrice($promotionPrice).' <del class="product-old-price">'.formatPrice($unitPrice).'</del></h4>';
	}
}
