					...
					<div class="box-body">
						<table id="example2" class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									<td>{{ $item->name }}</td>
									<td><img src="../upload/category/{{$item->image}}" width="100px"></td>
									...
									<td class="text-center">
										<a href="admin/hang-san-xuat/sua/{{ $item->id }}"><button type="button" class="btn btn-default"><i class="fa fa-edit"></i></button></a>
